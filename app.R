    ...
    sidebarLayout(
      ...
      mainPanel( width = 12,
                 ...
                 column(width = 12, splitLayout(
                   addSpinner(plotlyOutput(outputId = "map1"), spin = "fading-circle", color = "#375a7f"),
                   addSpinner(plotlyOutput(outputId = "map2"), spin = "fading-circle", color = "#375a7f"),
                   addSpinner(plotlyOutput(outputId = "map3"), spin = "fading-circle", color = "#375a7f")
                 )))
    ),
    ...
    sidebarLayout(
      ...
      mainPanel(width = 12,
                ...
                column(
                  width = 12, 
                  splitLayout(
                    addSpinner(plotlyOutput(outputId = "pointline1"), spin = "fading-circle", color = "#375a7f"),
                    addSpinner(plotlyOutput(outputId = "pointline2"), spin = "fading-circle", color = "#375a7f"),
                    addSpinner(plotlyOutput(outputId = "pointline3"), spin = "fading-circle", color = "#375a7f")
                  ) , 
                  ...
                  column(
                    width = 12, addSpinner(plotlyOutput(outputId = "Bar1"), spin = "fading-circle", color = "#375a7f"))))
    )
  )
  ,
  tabPanel(
